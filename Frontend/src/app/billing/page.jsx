...
export default function BillingPage() {
  ...
  const addToCart = (product) => {
    ...
    setCart((prev) => {
      ...
      if (existing) {
        // stock se zyada qty na jaane de
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-3 flex items-end justify-between">
                        ...
                        {cartItem ? (
                          <div className="flex items-center gap-2 rounded-lg bg-indigo-600 px-1.5 py-1.5">
                            ...
                            <button
                              ...
                              className="flex h-6 w-6 items-center justify-center rounded-md bg-white/20 text-sm font-bold text-white hover:bg-white/30"
                            >
                              −
                            </button>
                            ...
                            <button
                              ...
                              className="flex h-6 w-6 items-center justify-center rounded-md bg-white/20 text-sm font-bold text-white hover:bg-white/30 disabled:cursor-not-allowed disabled:opacity-40"
                            >
                              +
                            </button>
                          ...
                          <button
                            ...
                            disabled={outOfStock}
                            className="rounded-lg bg-indigo-600 px-3 py-2 text-xs font-semibold text-white transition group-hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-50"
                          >
                            + Add
                          </button>
                        )}
